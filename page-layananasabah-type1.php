<?php/** * Template Name: Layanan Nasabah: Type 1 */?>
<?php get_header();?>
<script src='//pixel.mathtag.com/event/js?mt_id=570146&mt_adid=125263&v1=&v2=&v3=&s1=&s2=&s3='></script>
	...
	<div id="wrapper" class="row">  
		...
		<section id="page-half" class="grey sections clearfix">
			<div class="large-8 columns p-all-0">
				...
				<?php //query konten halaman ini ada di widget/pengajuan-klaim.php ?>
				<?php get_template_part("widget/pengajuan-klaim");?>
			</div>
