<?php/** * Template Name: Bisnis :Solusi Archive */?>
<?php get_header();?>
<?php 
	...
	<div id="wrapper" class="row">
			<div id="masthead" class="row relative solusi-masterhead">
				<ul id="separate" class="bisnis relative cp-position--top0">
					<li><a href="<?php echo site_url('/') .$slug;?>">Personal</a></li>
					<li class="selected"><a href="<?php echo site_url('bisnis/') . $slug;?>">Bisnis</a></li>
				</ul>		
			</div>
			<!--Product listing-->
						...
						<div class="box-product">
							...
							<div>
								...
								<div class="bottom-section">
									...
									<a href="<?php echo site_url('bandingkan-produk/bisnis'.$bandingkanSlug);?>" class="c-red" style="font-size:0.8em;line-height:10px;" onclick="javascript:return tc_events_2(this,'interaction',{interaction_name:'Havas_Lebih_lanjut_<?=$post->post_name?>',interaction_detail:'click'});">BANDINGKAN PRODUK <span class="fa fa-arrow-right"></span></a>								</div>
							</div>
						</div>
			        </li>
			    <?php endforeach; ?>
