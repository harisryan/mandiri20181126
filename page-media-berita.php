<?php/** * Template Name: Media:berita */?>
<?php $selectedYear = ($_GET['fyear']) ? $_GET['fyear'] : ''; ?>
<?php get_header();?>
<script src='//pixel.mathtag.com/event/js?mt_id=570174&mt_adid=125263&v1=&v2=&v3=&s1=&s2=&s3='></script>
	...
	<div id="wrapper" class="row">
		<section class="bg-white3 clearfix radius-top-5">
			<div class="sections">
				...
				<ul id="media-nav" class="clearfix small-block-grid-1 medium-block-grid-1 large-block-grid-4">
					...
					<li class="berita uppercase selected"><a href="<?php echo site_url('media/berita');?>" class="block clearfix bg-white radius-all-5"><span class="icon-77x70 left"></span><strong class="inline"><?php /* _e("<!--:en-->News<!--:--><!--:id-->Berita<!--:-->"); */
		...
		<section class="bg-white4">
			...
			<?php
				...
				$args = array("post_type" => "post","posts_per_page" =>12, 'paged' => $paged, 'category_name'=>'berita', "year"=>$selectedYear);
				query_posts( $args );
