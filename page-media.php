...
<div id="page-container" style="background-image:url(<?php echo bloginfo('template_url');?>/images/header-berita.jpg);">
	...
	<div id="wrapper" class="row">
		<section class="bg-white4 clearfix radius-top-5">
			<div class="sections">
				...
				<ul id="media-nav" class="clearfix small-block-grid-1 medium-block-grid-1 large-block-grid-4">
					<li class="semua uppercase selected"><a href="<?php echo site_url('media');?>" class="block clearfix bg-white radius-all-5"><span class="icon-77x70 left"></span><strong class="inline"><?php /* _e("<!--:en-->All<!--:--><!--:id-->Semua<!--:-->"); */
					...
					<li class="video uppercase"><a href="<?php echo site_url('media/video');?>" class="block clearfix bg-white radius-all-5"><span class="icon-77x70 left"></span><strong class="inline"><?php /* _e("<!--:en-->video<!--:--><!--:id-->video<!--:-->"); */
		...
		<section class="bg-white4">
			...
			<?php
				...
				$args = array("post_type" => "post","posts_per_page" =>12, 'paged' => $paged, "year"=>$selectedYear, "cat"=>'-1214');
				query_posts( $args );
			...
			<div class="pagination text-center m-top-20 p-top-20 block clearfix"> <?php wp_pagenavi(); ?></div>
			</div>
		</section>
		...
		<section id="contact-section" class="clearfix background-vector relative no-border">
			...
			<div class="large-4 columns show-for-large-only first-child">
                ...
                <p>Untuk informasi atau data mengenai AXA Mandiri (produk, layanan, maupun aktivitas Perusahaan ) yang bersifat peliputan media, silakan menghubungi bagian Corporate Communications</p>
			...
			<div class="right large-7">
				<div class="large-6 columns bg-greydark radius-all-5 w-48p">
					<div class="box p-all-15">
						...
						<span>Luile R. Sawitri </span><br/>
						<ul class="clearfix">
							<li class="telepon">+62 21 3005 7160</li>
