	...
	<div id="masthead" class="row relative p-all-0">
		...
		<div id="page-head" class="relative m-top-150" style="background:#fcfdff url(<?php echo $image[0]; ?>) no-repeat top right">
			...
			<div class="box absolute set-1 large-5">
				...
				<?php if($slug=='asuransi-mandiri-jaminan-kesehatan' || $slug=='asuransi-mandiri-proteksi-kanker' || $slug=='asuransi-kesehatan' || $slug=='asuransi-mandiri-heart-protection'):?>
					<script type="text/javascript">
			...
			<form action="" id="form" name="form" method="post" class="wpcf7-form" novalidate="novalidate">
				...
				<div class="fieldset">
					<span class="wpcf7-form-control-wrap tgl_lahir">
						<input type="text" name="tgl_lahir" value="" size="40" class="required wpcf7-form-control wpcf7-text wpcf7-validates-as-required birthdate " aria-required="true" aria-invalid="false" placeholder="Tanggal Lahir cth: 2017-01-31" id="dp1392957616851">
					</span>
				</div>
