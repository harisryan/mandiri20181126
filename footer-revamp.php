...
<footer id="footer-copyright" aria-label="footer copyright">
    ...
    <!-- <div id="customercare-fixed" class="">
     ...
     <!-- online -->
    <!-- <div id="liveagent_button_online_5736F0000000FeC"
         class="liveagent liveagent_online"
         onclick="liveagent.startChat('5736F0000000FeC'); " />
         <img src="<?php echo bloginfo('template_url');?>/images/Live-Chat.png" alt="icon-chat" />
         <label>Live Chat</label>
         <i class="fa fa-angle-down" aria-hidden="true"></i>
    </div> -->

    <!-- offline -->
    <!-- <a class="liveagents" id="liveagents">
        <div class="liveagent_wrapper">
            <div id="liveagent_button_offline_5736F0000000FeC"
                 class="liveagent liveagent_offline"
                 src="<?php echo bloginfo('template_url');?>/images/Live-Chat.png"/>
                 <img src="<?php echo bloginfo('template_url');?>/images/Live-Chat.png" alt="icon-chat" />
                 <label>Live Chat</label>
                 <i class="fa fa-angle-down" aria-hidden="true"></i>
            </div>
            <div id="liveagent-details" class="clearfix p-all-20">
                <?php echo widget_livechat();?>
            </div>
        </div>
    </a> -->

    <div class="revamp-right-menu">
        <div class="content-rlm">
            <a href="" class="item-rlm">
                <img src="http://axamandiri.sudahdistaging.com/wp-content/uploads/2017/10/Health-Icons-15-rawat-jalan.png" alt="">
                <span>
                    <?php _e('Temikan Kebutuhan Anda') ?>
                </span>
            </a>
            <a href="#" onclick="liveagent.startChat('5736F0000000FeC'); return false;"  class="item-rlm" id="liveagent_button_online_5736F0000000FeC">
                <img src="http://axamandiri.sudahdistaging.com/wp-content/uploads/2017/10/Health-Icons-15-rawat-jalan.png" alt="">
                <span>
                    <?php _e('Live Chat') ?>
                </span>
            ...
            <a href="#" class="item-rlm" id="liveagent_button_offline_5736F0000000FeC">
                <img src="http://axamandiri.sudahdistaging.com/wp-content/uploads/2017/10/Health-Icons-15-rawat-jalan.png" alt="">
                <span>
...
<!--[if lt IE 9]>
    ...
    <style type="text/css">
        ...
        .revamp-right-menu .item-rlm img{
            width: 40px;
            display: inline-block;
            margin-bottom: 5px;   
        }

        .revamp-right-menu .item-rlm span{
            display: block;
            text-align: center;
        }
