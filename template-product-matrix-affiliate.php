...
<?php/** * Template Name: Page Builder: Affiliate Page */?>
<?php get_header();?>
	...
	function GetURLParameter(sParam)
	{
		...
		for(var i = 0; i< sURLVariables.length; i++)
		{
			...
			$(document).ready(function(){
				$("form input[name=referral_code]").val(GetURLParameter("ref"));
				$("form input[name=unique_code]").val('<?=$slug_product?>_' + GetURLParameter("ref"));
		 		//captcha check
				//captcha check
			    ...
			    $('#open-popup').on('click',function(e){
			    	e.preventDefault();
			    	$('#popup-usia').slideDown();
			    });

			    $('#close-pu, #close-top').on('click',function(e){
			    	e.preventDefault();
			    	$('#popup-usia').slideUp();
			    });
