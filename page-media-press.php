<?php/** * Template Name: Media:Press */?>
<?php $selectedYear = ($_GET['fyear']) ? $_GET['fyear'] : ''; ?>
<?php get_header();?>
<script src='//pixel.mathtag.com/event/js?mt_id=570176&mt_adid=125263&v1=&v2=&v3=&s1=&s2=&s3='></script>
<div id="page-container" style="background-image:url(<?php echo bloginfo('template_url');?>/images/header-berita.jpg);">
	<div id="masthead" class="row relative">
		...
		<div class="content large-6">
			...
			<div class="header2 cp-color--white">Cari tahu informasi dan berita terbaru mengenai AXA Mandiri</div>
	...
	<div id="wrapper" class="row">
		<section class="bg-white3 clearfix radius-top-5">
			<div class="sections">
				...
				<ul id="media-nav" class="clearfix small-block-grid-1 medium-block-grid-1 large-block-grid-4">
					...
					<li class="press uppercase selected"><a href="<?php echo site_url('media/press-release');?>" class="block clearfix bg-white radius-all-5"><span class="icon-77x70 left"></span><strong class="inline"><?php /* _e("<!--:en-->Press Release<!--:--><!--:id-->Siaran Pers<!--:-->"); */
		...
		<section class="bg-white4">
			...
			<?php
				...
				$args = array("post_type" => "post","posts_per_page" =>12, 'paged' => $paged, 'category_name'=>'siaran-pers', "year"=>$selectedYear);
				query_posts( $args );
