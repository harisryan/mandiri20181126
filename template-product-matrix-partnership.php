...
<?php/** * Template Name: Page Builder: Partnership */?>
<?php get_header();?>
...
<div class="expanded row main no-padding">
				...
				<div class="small-12 medium-12 large-8 columns no-padding content">
							...
							<div class="row" data-equalizer data-equalize-on="large">
								...
								<div class="large-4 columns no-padding" data-equalizer-watch>
									<?php if (has_post_thumbnail( $post->ID ) ): ?>
										...
										<img src="<?php echo $image[0]; ?>" class="float-right" alt="<?php get_the_title(); ?>">
									<?php endif; ?>
								</div>
					...
					<div class="section__article section__large">
						<div class="container-content-custom">
							<div class="row">
								<div class="small-12 columns content__article">
									<strong class="title-content-custom">
					            		<?php echo get_field( 'title_detail_content'); ?>
					            	</strong>
									<?php the_content(); ?>
								</div>
					...
					<div class="section__manfaat">
            			<div class="container-content-custom">
            				<div class="row">
            					<div class="small-12 column content__manfaat">
            						<strong class="title-content-custom">
					            		<?php echo get_field( 'title_manfaat'); ?>
					            	</strong>
            						<ul class="list__manfaat">
					                    <?php $i = 1; while(has_sub_field('matrix_manfaat')): ?>
					                        <li class="list__manfaat_item">
					                            <div class="list__manfaat_content">
					                                <img class="list__manfaat_icon" src="<?php the_sub_field("icon");?>" alt="<?php echo (!empty(get_sub_field('alt')))?get_sub_field('alt') : 'manfaat';?>">
					...
					<div class="section__syarat_ketentuan">
						<div class="container-content-custom">
				            <div class="row">
					            <div class="small-12 columns content__syarat">
					            	<strong class="title-content-custom">
					            		<?php echo get_field( 'title_syarat_ketentuan'); ?>
					            	</strong>
