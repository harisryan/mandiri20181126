...
class AdvTeaser extends ET_Builder_Module {

    function init () {
        $this->name = __( 'Advisor Teaser', 'axamandiri' );
        ...
        $this->fields_defaults = array(
            'title_section' => array( 'Advisor Teaser', 'add_default_setting' ),
        );
        $this->fullwidth  = true;
        $this->slug            = 'et_pb_adv_teaser';
        $this->child_slug      = 'et_pb_adv_teaser_item';
        $this->child_item_text = esc_html__( 'Advisor Teaser Item', 'axamandiri' );
    }
