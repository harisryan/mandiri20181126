...
class PMManfaat extends ET_Builder_Module {

    function init () {
        $this->name = __( 'PM Manfaat', 'axamandiri' );
        $this->slug = 'et_pb_pm_manfaat';
                ...
                <?php $i = 1; while(has_sub_field('matrix_manfaat')): ?>
                    <li class="manfaat-element text-center elements <?php if(($i % 2) == 0) echo 'dark'; ?>">
                        <div class="box p-all-20">
                            <img class="icon-manfaat custom-icon-manfaat" src="<?php the_sub_field("icon");?>" alt="<?php echo (!empty(get_sub_field('alt')))?get_sub_field('alt') : 'manfaat';?>">
