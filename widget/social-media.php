<div id="social-media">
	<div class="box">
		<h4><?php _e("<!--:en-->CONNECT WITH AXA Mandiri<!--:--><!--:id-->TERHUBUNG DENGAN AXA Mandiri<!--:-->"); ?></h4>
			<p class="border-bottom"><?php _e("<!--:en-->Follow and join AXA Mandiri account to receive news updates and events from AXA Mandiri <!--:--><!--:id-->Follow dan bergabung dengan akun AXA Mandiri untuk mendapat update berita dan event dari AXA Mandiri<!--:-->"); ?></p>
